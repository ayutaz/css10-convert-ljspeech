#!/usr/bin/env python3
"""
librosaを使用してWAVファイルの音声長を詳細に分析するスクリプト
IEEE浮動小数点フォーマット対応
"""
...
def analyze_durations():
    """音声長を分析"""
    print("=== librosaを使用したWAVファイル音声長分析 ===\n")
...
def create_duration_histogram(durations, lang_durations):
    ...
    plt.tight_layout()
    plt.savefig('audio_duration_analysis_librosa.png', dpi=300, bbox_inches='tight')
    print(f"\n分布図を 'audio_duration_analysis_librosa.png' に保存しました")
